...
The labs did prepare me for the assignment. Especially getting used to the new software we used in this project. Had we begun installing, setting up and right away using all the new software this project would have been daunting. 
...
N/A (didn't do demo). My peer added stretch features that made the site more functional such as having a search bar and styled UI that benefited the user in readability. 
...
Shoutout Hartwell for helping me connect frontend + backend! 
